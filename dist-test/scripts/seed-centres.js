...
const centres = [
    {
        ...
        description: 'We provide a safe, stimulating environment for children aged 0-6 years. Our experienced educators focus on holistic development through play-based learning. We have been serving the Alexandra community for over 10 years.',
    ...
    },
    {
        ...
        description: 'Family-run daycare with focus on emotional intelligence and social skills. We believe in learning through play and creating a home away from home for your little ones.',
    ...
    },
    {
        ...
        description: 'Grade R preparation specialists. Our curriculum focuses on school readiness, literacy, and numeracy. We have a 95% success rate for primary school placement.',
    ...
    },
    {
        ...
        description: "Child-led learning environment following Montessori principles. We focus on independence, hands-on learning, and respect for each child's unique development pace.",
    ...
    },
    {
        ...
        description: 'Inclusive childcare celebrating diversity. We accommodate children with special needs and provide individualized learning plans. Multilingual staff (English, Zulu, Sotho, Afrikaans).',
    ...
    },
    {
        ...
        description: 'Award-winning preschool in the heart of Soweto. We combine traditional values with modern teaching methods.',
...
const DEFAULT_ECD_COVER = 'https://images.pexels.com/photos/8363783/pexels-photo-8363783.jpeg?cs=srgb&dl=pexels-rdne-8363783.jpg&fm=jpg';
...
async function seedCentres() {
    ...
    for (const centre of centres) {
        const centrePayload = Object.assign(Object.assign({}, centre), { cover_image_url: (_a = ECD_COVER_BY_SLUG[centre.slug]) !== null && _a !== void 0 ? _a : DEFAULT_ECD_COVER });
        const { data, error } = await supabase
            ...
            .single();
        if (error || !data) {
            console.error(`Failed to create/update ${centre.name}:`, (_b = error === null || error === void 0 ? void 0 : error.message) !== null && _b !== void 0 ? _b : 'Unknown error');
            continue;
        }
