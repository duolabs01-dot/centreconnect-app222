...
const supabaseUrl = (_a = process.env.SUPABASE_URL) !== null && _a !== void 0 ? _a : process.env.NEXT_PUBLIC_SUPABASE_URL;
const serviceRoleKey = (_b = process.env.SUPABASE_SERVICE_ROLE_KEY) !== null && _b !== void 0 ? _b : process.env.SUPABASE_SERVICE_KEY;
...
async function fetchDynamicCentrePaths() {
    ...
    for (const centre of centres !== null && centres !== void 0 ? centres : []) {
        const slug = (_a = centre.slug) === null || _a === void 0 ? void 0 : _a.trim();
        if (!slug)
            continue;
        pathSet.add(`/c/${slug}`);
...
async function fetchJobPaths() {
    ...
    for (const job of jobs !== null && jobs !== void 0 ? jobs : []) {
        const slug = (_b = (_a = job.ecd_centres) === null || _a === void 0 ? void 0 : _a.slug) === null || _b === void 0 ? void 0 : _b.trim();
        if (!slug || !job.id)
            continue;
