...
exports.renderBaseEmailLayout = renderBaseEmailLayout;
...
function renderBaseEmailLayout(input) {
    var _a, _b;
    const appUrl = ((_a = input.appBaseUrl) !== null && _a !== void 0 ? _a : 'https://centerconnect.co.za').replace(/\/$/, '');
    const logoUrl = ((_b = input.logoUrl) === null || _b === void 0 ? void 0 : _b.trim()) || `${appUrl}/centreconnect-logo-email.png`;
