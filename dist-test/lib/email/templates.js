...
exports.renderParentWelcomeBackEmail = renderParentWelcomeBackEmail;
function applicationStatusEmail({ parentName, childName, centreName, newStatus, appUrl, }) {
    var _a;
    const statusLabels = {
    ...
    const label = (_a = statusLabels[newStatus]) !== null && _a !== void 0 ? _a : `has been updated to: ${newStatus}`;
...
function resolveFirstName(value) {
    var _a;
    const trimmed = value.trim();
    if (!trimmed)
        return 'there';
    return (_a = trimmed.split(/\s+/)[0]) !== null && _a !== void 0 ? _a : 'there';
}
function renderParentWelcomeBackEmail(input) {
    var _a, _b;
    ...
    const logoUrl = ((_b = input.logoUrl) === null || _b === void 0 ? void 0 : _b.trim()) || `${appBaseUrl}/centreconnect-logo-email.png`;
