...
exports.renderOwnerInviteEmail = renderOwnerInviteEmail;
...
function renderOwnerInviteEmail(input) {
    var _a;
    const subject = 'Your CentreConnect account is ready';
    const primaryActionLabel = ((_a = input.primaryActionLabel) === null || _a === void 0 ? void 0 : _a.trim()) || 'Open my workspace';
    const htmlContent = `
  ...
  `;
    const { html, text } = (0, email_layout_1.renderBaseEmailLayout)({
        theme: 'ecd',
