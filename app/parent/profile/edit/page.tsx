    ...
    return (
      <div className="cc-page">
        <div className="space-y-4">
          ...
          <div
            className="rounded-3xl border border-slate-200 bg-gradient-to-b from-white to-slate-50/80 p-4 shadow-sm sm:p-6
                       ...
                       [&_button[type=submit]]:w-full [&_button[type=submit]]:rounded-2xl [&_button[type=submit]]:bg-cyan-600 [&_button[type=submit]]:py-4 [&_button[type=submit]]:font-semibold [&_button[type=submit]]:text-white [&_button[type=submit]]:transition-colors [&_button[type=submit]]:shadow-lg [&_button[type=submit]]:shadow-cyan-200/50 [&_button[type=submit]]:hover:bg-cyan-700"
          >
            <ParentProfileEditor
              initial={{
