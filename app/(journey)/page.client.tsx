...
export default function HomeClientPage({ userEmail, jobOpportunities, shortlistCentres }: HomeClientPageProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 selection:bg-cyan-100 selection:text-cyan-900">
      <main className="w-full pb-[calc(env(safe-area-inset-bottom)+4rem)]">
        <div className="flex flex-col">
          {/* SECTION 2 - Hero Section (Full Bleed) */}
          <section className="relative pt-[120px] pb-20 sm:pt-[160px] sm:pb-32 lg:pb-40 bg-slate-900 overflow-hidden">
          ...
          <section className="bg-slate-900 py-20 sm:py-32 lg:py-40 text-white overflow-hidden">
            <Container>
          ...
          <section className="py-20 sm:py-32 lg:py-40 bg-white border-y border-slate-100 relative overflow-hidden">
          ...
          <section className="py-20 sm:py-32 lg:py-40 bg-slate-50/50">
            <Container>
          ...
          <section className="bg-slate-900 py-20 sm:py-32 lg:py-40 text-white relative overflow-hidden">
