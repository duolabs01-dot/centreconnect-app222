...
import { DashboardContextStrip } from '@/components/ecd/dashboard-context-strip'
import { FeatureDiscoveryCards } from '@/components/ecd/feature-discovery-cards'
      ...
      <div className="space-y-6 pb-10">
        ...
        {isFirstWeek && (
          <DashboardContextStrip
            ...
            attendanceToday={snapshot.attendance_today_count ?? 0}
            hasLogo={!!centre?.logo_url}
            hasCover={!!centre?.cover_image_url}
            tier={subscriptionTier as import('@/lib/billing/plans').InternalTier}
          />
        )}
