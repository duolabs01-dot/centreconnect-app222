...
export const metadata: Metadata = {
  title: "AI Document Upload — CentreConnect",
}
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
      <div className="rounded-2xl border border-slate-200 bg-white p-10 max-w-md">
        ...
        <h1 className="text-xl font-bold text-slate-900">AI Document Upload</h1>
        <p className="mt-2 text-sm text-slate-500">Upload DSD documents — AI reads and files them.</p>
