...
export default function EcdErrorPage({ error, reset }: ErrorPageProps) {
  ...
  return (
    <div className="ecd-light-shell min-h-screen bg-background px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-xl rounded-2xl border border-border bg-card/80 p-8 text-center shadow-[0_18px_42px_rgba(2,6,23,0.18)] backdrop-blur-sm">
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-center">
          <Button onClick={reset} className="bg-cyan-600 text-white hover:bg-cyan-500">Try Again</Button>
