...
❌ AI extraction audit FAILED: AI extraction failed: AI extraction request failed (404): {
  "error": {
    "code": 404,
    "message": "models/gemini-pro-flash is not found for API version v1beta, or is not supported for generateContent. Call ListModels to see the list of available models and their supporte