...
Last updated: 2026-03-06 (parent live smoke scripted)
Owner: Founder
...
- Current bottleneck: Parent copy consistency across all primary screens.
- Active lane: `parent reliability + copy quality`

## Now

- [ACTIVE] `BL-PARENT-009` `parent` Finish plain-English copy pass across parent primary flows
  - Why: Parent language is still inconsistent and too technical in key UI surfaces.
  - Definition of done:
    - Replace technical/jargon-heavy copy in parent primary flows with plain English.
    - Keep labels concise and consistent across dashboard, profile, children, documents, and emergency flows.
    - Preserve action intent and avoid regressions in UX hints.
  - Validation:
